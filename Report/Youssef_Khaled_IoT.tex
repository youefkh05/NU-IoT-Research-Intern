...
\begin{IEEEkeywords}
Internet of Things (IoT), Embedded Systems, Raspberry Pi, Embedded Linux, RTOS, MQTT, HTTP, InfluxDB, Grafana, UART, Bluetooth, Zigbee.
\end{IEEEkeywords}
...
\subsection*{Weeks 4--5: Integration and System-Level Development}
\begin{itemize}
    \item Communication between the Raspberry Pi and the RTOS microcontroller.
    \item Making the RTOS microcontroller publish sensor measurements to the MQTT broker.
\end{itemize}
