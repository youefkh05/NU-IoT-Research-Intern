...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\columnwidth]{../Figures/IoT_Architecture.pdf}
...
The developed IoT platform successfully demonstrated complete cloud connectivity and real-time monitoring capabilities. Sensor measurements were reliably transmitted from the Raspberry Pi, stored within a time-series database, and visualized through interactive dashboards.
...
\includegraphics[width=.47\columnwidth]{../Tasks/Task4/T4_Adafruit.jpeg}}

\hfill

\subfloat[Grafana dashboard.]{
\includegraphics[width=.47\columnwidth]{../Tasks/Task4/T4_Grafana.jpeg}}

\caption{Cloud dashboards used for monitoring sensor measurements.\cite{videos}}
